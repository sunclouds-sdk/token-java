...
/**
 * CodecUtils.
 * Explainations as followings by zhangfeng@yy.com<br>
 * Based on big-endian mode. that's is:<br>
 * 1) low bit-byte pushed high position in memory, and accordingly high bit-byte pushed low position in memory.
 * 2) little-endian mode is opposite directions with big-endian.
 */
...
public class Bytes {
    ...
    /**
     * to byte array.
     * big-endian mode, that's low byte pushed high position in memory. added by zhangfeng@yy.com
     *
     * @param v value.
     * @param b byte array.
     */
